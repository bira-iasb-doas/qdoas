  ...
  QFrame(parent)
{
  ...
  m_chosenList->setSelectionMode(QAbstractItemView::MultiSelection);

  // populate the with all possible fields initially

  m_availableList->addItem(new CWOutputFieldItem(PRJCT_RESULTS_ASCII_SPECNO, "Spectrum Number"));
  m_availableList->addItem(new CWOutputFieldItem(PRJCT_RESULTS_ASCII_NAME, "Name"));
  m_availableList->addItem(new CWOutputFieldItem(PRJCT_RESULTS_ASCII_DATE_TIME, "Date & Time"));
  m_availableList->addItem(new CWOutputFieldItem(PRJCT_RESULTS_ASCII_DATE, "Date"));
  m_availableList->addItem(new CWOutputFieldItem(PRJCT_RESULTS_ASCII_TIME, "Time"));
  m_availableList->addItem(new CWOutputFieldItem(PRJCT_RESULTS_ASCII_YEAR, "Year"));
  m_availableList->addItem(new CWOutputFieldItem(PRJCT_RESULTS_ASCII_JULIAN, "Julian Date"));
  m_availableList->addItem(new CWOutputFieldItem(PRJCT_RESULTS_ASCII_JDFRAC, "JD Frac"));
  m_availableList->addItem(new CWOutputFieldItem(PRJCT_RESULTS_ASCII_TIFRAC, "TI Frac"));
  ...
  m_availableList->addItem(new CWOutputFieldItem(PRJCT_RESULTS_ASCII_SZA, "Solar Zenith Angle"));
  m_availableList->addItem(new CWOutputFieldItem(PRJCT_RESULTS_ASCII_CHI, "Chi"));
  m_availableList->addItem(new CWOutputFieldItem(PRJCT_RESULTS_ASCII_RMS, "RMS"));
  m_availableList->addItem(new CWOutputFieldItem(PRJCT_RESULTS_ASCII_AZIM, "Azimuth"));
  m_availableList->addItem(new CWOutputFieldItem(PRJCT_RESULTS_ASCII_TDET, "Detector Temperature"));
  m_availableList->addItem(new CWOutputFieldItem(PRJCT_RESULTS_ASCII_SKY, "Sky"));
  m_availableList->addItem(new CWOutputFieldItem(PRJCT_RESULTS_ASCII_BESTSHIFT, "Best Shift"));
  m_availableList->addItem(new CWOutputFieldItem(PRJCT_RESULTS_ASCII_REFZM, "Ref ZM"));
  m_availableList->addItem(new CWOutputFieldItem(PRJCT_RESULTS_ASCII_REFSHIFT, "Ref Shift"));
  m_availableList->addItem(new CWOutputFieldItem(PRJCT_RESULTS_ASCII_PIXEL, "Pixel"));
  m_availableList->addItem(new CWOutputFieldItem(PRJCT_RESULTS_ASCII_PIXEL_TYPE, "Pixel Type"));
  m_availableList->addItem(new CWOutputFieldItem(PRJCT_RESULTS_ASCII_ORBIT, "Orbit"));
  ...
  m_availableList->addItem(new CWOutputFieldItem(PRJCT_RESULTS_ASCII_COVAR, "Covariance"));
  m_availableList->addItem(new CWOutputFieldItem(PRJCT_RESULTS_ASCII_CORR, "Correlation"));
  m_availableList->addItem(new CWOutputFieldItem(PRJCT_RESULTS_ASCII_CLOUD, "Cloud"));
  m_availableList->addItem(new CWOutputFieldItem(PRJCT_RESULTS_ASCII_COEFF, "Coefficient"));
  m_availableList->addItem(new CWOutputFieldItem(PRJCT_RESULTS_ASCII_O3, "O3"));
  m_availableList->addItem(new CWOutputFieldItem(PRJCT_RESULTS_ASCII_NO2, "NO2"));
  m_availableList->addItem(new CWOutputFieldItem(PRJCT_RESULTS_ASCII_CLOUDTOPP, "Cloud Top P"));
  ...
  m_availableList->addItem(new CWOutputFieldItem(PRJCT_RESULTS_ASCII_VIEW_ELEVATION, "View Elevation"));
  m_availableList->addItem(new CWOutputFieldItem(PRJCT_RESULTS_ASCII_VIEW_AZIMUTH, "View Azimuth"));
  m_availableList->addItem(new CWOutputFieldItem(PRJCT_RESULTS_ASCII_SCIA_QUALITY, "SCIA Quality"));
  m_availableList->addItem(new CWOutputFieldItem(PRJCT_RESULTS_ASCII_SCIA_STATE_INDEX, "SCIA State Index"));
  m_availableList->addItem(new CWOutputFieldItem(PRJCT_RESULTS_ASCII_SCIA_STATE_ID, "SCIA State ID"));
  m_availableList->addItem(new CWOutputFieldItem(PRJCT_RESULTS_ASCII_MFC_STARTTIME, "MFC Start-time"));
  m_availableList->addItem(new CWOutputFieldItem(PRJCT_RESULTS_ASCII_MFC_ENDTIME, "MFC End-time"));
