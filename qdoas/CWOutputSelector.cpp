  ...
  QFrame(parent)
{
  ...
  m_availableList->addItem(new CWOutputFieldItem(PRJCT_RESULTS_ASCII_GOME2_SCANDIRECTION,    "Scan direction"         ));
    ...
    case PRJCT_INSTR_FORMAT_GOME2 :
     {
      ...
      validFlags[PRJCT_RESULTS_ASCII_GOME2_SCANDIRECTION]=1;
      validFlags[PRJCT_RESULTS_ASCII_GOME2_SAA]=1;
      validFlags[PRJCT_RESULTS_ASCII_GOME2_SUNGLINT_RISK]=1;
      validFlags[PRJCT_RESULTS_ASCII_GOME2_SUNGLINT_HIGHRISK]=1;
      validFlags[PRJCT_RESULTS_ASCII_GOME2_RAINBOW]=1;
     }
    break;
 // ----------------------------------------------------------------------------
