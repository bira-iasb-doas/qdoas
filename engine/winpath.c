...
UCHAR (*PATH_fileNamesShort)[MAX_STR_SHORT_LEN+1];                              // list of subdirectories and files found in a specified directory
...
UCHAR   PATH_fileMax[MAX_STR_SHORT_LEN+1];
...
// QDOAS ???   DIR *hDir;
// QDOAS ???   UCHAR tmpdir[MAX_STR_LEN+1];
// QDOAS ???   #endif
