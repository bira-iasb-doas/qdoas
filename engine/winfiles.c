...
// QDOAS ??? 
// QDOAS ??? // -----------------------------------------------------------------------------
// QDOAS ??? // FUNCTION      FILES_BuildFileName
// QDOAS ??? // -----------------------------------------------------------------------------
// QDOAS ??? // PURPOSE       Build a file name from a given name and extension
// QDOAS ??? //
// QDOAS ??? // INPUT/OUTPUT  fileName  the original file name
// QDOAS ??? // INPUT         fileType  the type of file to build
// QDOAS ??? //
// QDOAS ??? // OUTPUT        pointer to the updated file name
// QDOAS ??? // -----------------------------------------------------------------------------
// QDOAS ??? 
// QDOAS ??? UCHAR *FILES_BuildFileName(UCHAR *fileName,MASK fileType)
// QDOAS ???  {
// QDOAS ???   // Declarations
// QDOAS ??? 
...
// QDOAS ??? 
// QDOAS ???   if (((fileNameLength=strlen(fileName))!=0) && (fileType>FILE_TYPE_ALL))
// QDOAS ???    {
// QDOAS ???     if ((ptr=strrchr(fileName,'.'))==NULL)
// QDOAS ???      ptr=&fileName[fileNameLength];
// QDOAS ??? 
// QDOAS ???     sprintf(ptr,".%s",FILES_types[fileType].fileExt);
// QDOAS ???    }
// QDOAS ??? 
// QDOAS ???   // Return
// QDOAS ??? 
// QDOAS ???   return fileName;
// QDOAS ???  }
// QDOAS ??? 
// QDOAS ??? #if defined(__WINDOAS_GUI_) && (__WINDOAS_GUI_)
// QDOAS ??? 
