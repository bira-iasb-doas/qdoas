...
// QDOAS ??? // -----------------------------------------------------------------------------
// QDOAS ???
// QDOAS ??? INDEX SYMB_GetListIndex(SYMBOL *symbolList,INT symbolNumber,unsigned char *fileName)
// QDOAS ???  {
// QDOAS ???   // Declarations
// QDOAS ???
// QDOAS ???   unsigned char symbolName[MAX_PATH_LEN+1],*ptr;                                        // the name of the symbol to search for
